# Generated by Django 3.0.4 on 2020-05-06 22:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approver_name', models.CharField(blank=True, max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject_no', models.CharField(blank=True, max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sem_year_taken', models.CharField(blank=True, max_length=20, null=True)),
                ('expiration_date', models.DateField()),
                ('approved_status', models.CharField(blank=True, max_length=5, null=True)),
